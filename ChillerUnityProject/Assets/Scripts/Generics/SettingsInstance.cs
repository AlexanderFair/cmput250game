...
public class SettingsInstance : MonoBehaviour
{
    ...
    public KeyCodeValue[] controlsValues =
    {
        ...
        new KeyCodeValue { key = Controls.Escape, value = KeyCode.Escape },
    ...
    public readonly Dictionary<Controls, KeyCodeValue> controlsPairings = new Dictionary<Controls, KeyCodeValue>();
    public readonly Dictionary<FloatValues, FloatValue> floatPairings = new Dictionary<FloatValues, FloatValue>();
    public readonly Dictionary<PrefabAnimations, PrefabAnimationValue> animPairings = new Dictionary<PrefabAnimations, PrefabAnimationValue>();
    public readonly Dictionary<PrefabObjects, PrefabObjectValue> objectPairings = new Dictionary<PrefabObjects, PrefabObjectValue>();
...
public static class Settings
{
    ...
    {
        Interact, LeftClick, Escape, RightClick, DialogSkip
    }
