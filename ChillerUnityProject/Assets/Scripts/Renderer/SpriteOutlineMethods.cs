...
public static class SpriteOutlineMethods
{
    public static void StartOutlinableSprite<T>(this T outlineableSprite, SpriteRenderer outlineableSpriteRenderer) where T : MonoBehaviour, IOutlineableSprite
    {
        ...
        outliner.SetupOutline(outlineableSpriteRenderer, outlineableSprite.OutlineType().Get(), Random.Range(Settings.FloatValues.SecondsPerOutlineCycleMin.Get(), Settings.FloatValues.SecondsPerOutlineCycleMax.Get()), Settings.PrefabMaterials.Outline.Get());
