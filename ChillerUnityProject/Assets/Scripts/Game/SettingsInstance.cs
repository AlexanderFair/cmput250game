...
public class SettingsInstance : MonoBehaviour
{
    ...
    public List<SettingsUpdateWatcher> settingsValueChangeWatchers = new List<SettingsUpdateWatcher>();
    ...
    {
        foreach (SettingsUpdateWatcher s in settingsValueChangeWatchers)
        {
            s.UpdateSetting(e);
        }
    }
...
public static class Settings
{
    ...
    public enum FloatValues
    {
        ...
        AmbientVolume, SoundtrackVolume, SoundEffectVolume
    }
    ...
    public class SettingsUpdateWatcher : MonoBehaviour
    {
        public void UpdateSetting(object e)
        {
            switch (e)
            {
                case FloatValues f:
                    FloatValuesUpdated(f); break;
                case Controls c:
                    ControlsUpdated(c); break;
                default:
                    break;
            }
        }

        public virtual void FloatValuesUpdated(FloatValues floatVal) { }
        public virtual void ControlsUpdated(Controls control) { }
